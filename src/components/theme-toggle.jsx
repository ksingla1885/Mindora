...
export function ThemeToggle() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="min-w-[150px] bg-white/90 dark:bg-[#020817]/80 backdrop-blur-xl border border-slate-200 dark:border-slate-800 shadow-xl">
